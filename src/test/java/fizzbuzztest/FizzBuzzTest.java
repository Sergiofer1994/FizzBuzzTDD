...
public class FizzBuzzTest {
    ...
    public void check_1_to_1() {
        assertEquals("1", new org.example.fizzbuzz.FizzBuzz().convert(1));
    }

    @Test
    public void check_2_to_2() {
        assertEquals("2" , new org.example.fizzbuzz.FizzBuzz().convert(2));
    }

    @Test
    public void check_3_to_Fizz() {
        assertEquals("Fizz", new org.example.fizzbuzz.FizzBuzz().convert(3));
    }

    @Test
    public void check_5_to_Buzz(){
        assertEquals("Buzz", new org.example.fizzbuzz.FizzBuzz().convert(5));
    }

    @Test
    public void check_15_to_FizzBuzz() {
        assertEquals("FizzBuzz", new org.example.fizzbuzz.FizzBuzz().convert(15));
    }
